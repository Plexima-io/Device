(function () {
  ...
  var MARKUP = [
    ...
    '<div class="form-field"><label for="k-jmeno">Jméno <span class="req">*</span></label><input type="text" id="k-jmeno" name="jmeno" required autocomplete="given-name"></div>',
    '<div class="form-field"><label for="k-prijmeni">Příjmení <span class="req">*</span></label><input type="text" id="k-prijmeni" name="prijmeni" required autocomplete="family-name"></div>',
