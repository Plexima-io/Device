(function () {
  ...
  var init = function () {
    ...
    var MARKUP = [
      ...
      '<div class="form-field"><label for="o-jmeno">Jméno <span class="req">*</span></label><input type="text" id="o-jmeno" name="jmeno" required autocomplete="given-name"></div>',
      '<div class="form-field"><label for="o-prijmeni">Příjmení <span class="req">*</span></label><input type="text" id="o-prijmeni" name="prijmeni" required autocomplete="family-name"></div>',
