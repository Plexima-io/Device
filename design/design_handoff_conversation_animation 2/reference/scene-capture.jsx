...
function SceneContent() {
  ...
  SPK.forEach((s, k) => {
    ...
    els.push(React.createElement('div', { key:'sp'+k, style:{ position:'absolute', left, top, width:176, height:60, borderRadius:16, background:'#fff', border:'1px solid '+C.cardBd, boxShadow:'0 16px 38px rgba(23,23,58,'+(0.12+env*0.10)+'), 0 4px 10px rgba(23,23,58,0.08)', display:'flex', alignItems:'center', gap:11, padding:'0 14px', boxSizing:'border-box', transform:'scale('+(0.97+env*0.03)+')', opacity:0.62+env*0.38 } },
      // avatar
